...
struct Unicorn basedeck[] = {
    ...
    {BASICUNICORN, UNICORN, "Basic Unicorn (Orange)",
     "Pumpkin spice is the pumpkin spice of life.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Orange)",
     "Pumpkin spice is the pumpkin spice of life.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Orange)",
     "Pumpkin spice is the pumpkin spice of life.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Yellow)",
     "Dance like nobody's watching.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Yellow)",
     "Dance like nobody's watching.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Yellow)",
     "Dance like nobody's watching.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Green)",
     "Vinyl records and mixtapes only.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Green)",
     "Vinyl records and mixtapes only.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Green)",
     "Vinyl records and mixtapes only.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Blue)",
     "Popped collars are for date nights only.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Blue)",
     "Popped collars are for date nights only.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Blue)",
     "Popped collars are for date nights only.", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Indigo)", "[emojis]", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Indigo)", "[emojis]", NOTHING, NULL, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Indigo)", "[emojis]", NOTHING, NULL, 0},
    ...
    {BASICUNICORN, NARWHAL, "Narwhal",
     "This card has no special powers, but it sure is cute!", NOTHING, NULL, 0},
    {BASICUNICORN, NARWHAL, "Narwhal",
     "This card has no special powers, but it sure is cute!", NOTHING, NULL, 0},
    {BASICUNICORN, NARWHAL, "Narwhal",
     "This card has no special powers, but it sure is cute!", NOTHING, NULL, 0},
    ...
    {MAGICUNICORN, UNICORN, "Extremely Destructive Unicorn",
     ...
     extremely_destructive_unicorn, NULL, 0},
    ...
    {MAGICUNICORN, UNICORN, "Ginormous Unicorn",
     "This card counts for 2 Unicorns. You cannot play any Instant cards.", ginormous_unicorn_effect, NULL, 0},
    {MAGICUNICORN, UNICORN, "Seductive Unicorn",
     "When this card enters your Stable, you may DISCARD a card, then STEAL a "
     "Unicorn card.",
     seductive_unicorn, NULL, 0},
    {MAGICUNICORN, UNICORN, "Angel Unicorn",
     ...
     angel_unicorn, NULL, 0},
    {MAGICUNICORN, UNICORN, "Queen Bee Unicorn",
     "Basic Unicorn cards cannot enter any player's Stable except yours.", queen_bee_unicorn_effect, NULL, 0},
    ...
    {MAGICUNICORN, UNICORN, "Annoying Flying Unicorn",
     ...
     "your hand.",
     annoying_flying_unicorn, NULL, 0},
    ...
    {MAGICUNICORN, NARWHAL, "The Great Narwhal",
     ...
     "deck.",
     the_great_narwhal, NULL, 0},
    {MAGIC, NOSPECIES, "Unicorn Poison", "DESTROY a Unicorn card.", unicorn_poison, NULL, 0},
    {MAGIC, NOSPECIES, "Unicorn Poison", "DESTROY a Unicorn card.", unicorn_poison, NULL, 0},
    {MAGIC, NOSPECIES, "Unicorn Poison", "DESTROY a Unicorn card.", unicorn_poison, NULL, 0},
    ...
    {MAGIC, NOSPECIES, "Change of Luck",
     "DRAW 2 cards and DISCARD 3 cards, then take another turn.", change_of_luck, NULL, 0},
    {MAGIC, NOSPECIES, "Change of Luck",
     "DRAW 2 cards and DISCARD 3 cards, then take another turn.", change_of_luck, NULL, 0},
    {MAGIC, NOSPECIES, "Glitter Tornado",
     "Return a card in each player's Stable (including yours) to their hand.",
     glitter_tornado, NULL, 0},
    {MAGIC, NOSPECIES, "Glitter Tornado",
     "Return a card in each player's Stable (including yours) to their hand.",
     glitter_tornado, NULL, 0},
    ...
    {MAGIC, NOSPECIES, "Unicorn Shrinkray",
     ...
     "player's Stable.",
     unicorn_shrinkray, NULL, 0},
    {MAGIC, NOSPECIES, "Targeted Destruction",
     "DESTROY an Upgrade card or SACRIFICE a Downgrade card.", targeted_destruction, NULL, 0},
    {MAGIC, NOSPECIES, "Mystical Vortex",
     "Each player (including you) must DISCARD a card. Shuffle the discard "
     "pile into the deck.",
     mystical_vortex, NULL, 0},
    {MAGIC, NOSPECIES, "Good Deal", "DRAW 3 cards and DISCARD a card", good_deal, NULL, 0},
    ...
    {UPGRADE, NOSPECIES, "Glitter Bomb",
     ...
     "SACRIFICE a card, then DESTROY a card.",
     glitter_bomb, NULL, 0},
    {UPGRADE, NOSPECIES, "Yay", "Cards you play cannot be Neigh'd.", yay_effect, NULL, 0},
    {UPGRADE, NOSPECIES, "Yay", "Cards you play cannot be Neigh'd.", yay_effect, NULL, 0},
    {UPGRADE, NOSPECIES, "Unicorn Lasso",
     ...
     unicorn_lasso, NULL, 0},
    {UPGRADE, NOSPECIES, "Rainbow Aura",
     "Your Unicorn cards cannot be destroyed.", rainbow_aura_effect, NULL, 0},
