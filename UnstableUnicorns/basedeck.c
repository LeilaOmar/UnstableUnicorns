...
struct Unicorn Base_DECK[] = {
    ...
    {BASICUNICORN, UNICORN, "Basic Unicorn (Orange)",
     "Pumpkin spice is the pumpkin spice of life.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Orange)",
     "Pumpkin spice is the pumpkin spice of life.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Orange)",
     "Pumpkin spice is the pumpkin spice of life.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Yellow)",
     "Dance like nobody's watching.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Yellow)",
     "Dance like nobody's watching.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Yellow)",
     "Dance like nobody's watching.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Green)",
     "Vinyl records and mixtapes only.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Green)",
     "Vinyl records and mixtapes only.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Green)",
     "Vinyl records and mixtapes only.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Blue)",
     "Popped collars are for date nights only.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Blue)",
     "Popped collars are for date nights only.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Blue)",
     "Popped collars are for date nights only.", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Indigo)", "[emojis]", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Indigo)", "[emojis]", NOTHING, 0},
    {BASICUNICORN, UNICORN, "Basic Unicorn (Indigo)", "[emojis]", NOTHING, 0},
    ...
    {BASICUNICORN, NARWHAL, "Narwhal",
     "This card has no special powers, but it sure is cute!", NOTHING, 0},
    {BASICUNICORN, NARWHAL, "Narwhal",
     "This card has no special powers, but it sure is cute!", NOTHING, 0},
    {BASICUNICORN, NARWHAL, "Narwhal",
     "This card has no special powers, but it sure is cute!", NOTHING, 0},
    ...
    {MAGICALUNICORN, UNICORN, "Extremely Destructive Unicorn",
     ...
     EXTREMELY_DESTRUCTIVE_UNICORN, 0},
    ...
    {MAGICALUNICORN, UNICORN, "Ginormous Unicorn",
     "This card counts for 2 Unicorns. You cannot play any Instant cards.", GINORMOUS_UNICORN_EFFECT, 0},
    ...
    {MAGICALUNICORN, UNICORN, "Queen Bee Unicorn",
     "Basic Unicorn cards cannot enter any player's Stable except yours.", QUEEN_BEE_UNICORN_EFFECT, 0},
    ...
    {MAGICALUNICORN, UNICORN, "Unicorn on the Cob",
     "When this card enters your Stable, DRAW 2 cards and DISCARD a card.", UNICORN_ON_THE_COB, 0},
    {MAGICALUNICORN, UNICORN, "Black Knight Unicorn",
     "If a Unicorn card in your Stable would be destroyed, you may SACRIFICE "
     "this card instead.",
     BLACK_KNIGHT_UNICORN_EFFECT, 0},
    ...
    {MAGICALUNICORN, NARWHAL, "Alluring Narwhal",
     "When this card enters your Stable, you may STEAL an Upgrade card.", ALLURING_NARWHAL, 0},
    ...
    {MAGICALUNICORN, NARWHAL, "The Great Narwhal",
     ...
     "deck.",
     THE_GREAT_NARWHAL, 0},
    {MAGIC, NOSPECIES, "Unicorn Poison", "DESTROY a Unicorn card.", UNICORN_POISON, 0},
    {MAGIC, NOSPECIES, "Unicorn Poison", "DESTROY a Unicorn card.", UNICORN_POISON, 0},
    {MAGIC, NOSPECIES, "Unicorn Poison", "DESTROY a Unicorn card.", UNICORN_POISON, 0},
    ...
    {MAGIC, NOSPECIES, "Change of Luck",
     "DRAW 2 cards and DISCARD 3 cards, then take another turn.", CHANGE_OF_LUCK, 0},
    {MAGIC, NOSPECIES, "Change of Luck",
     "DRAW 2 cards and DISCARD 3 cards, then take another turn.", CHANGE_OF_LUCK, 0},
    ...
    {MAGIC, NOSPECIES, "Targeted Destruction",
     "DESTROY an Upgrade card or SACRIFICE a Downgrade card.", TARGETED_DESTRUCTION, 0},
    {MAGIC, NOSPECIES, "Mystical Vortex",
     "Each player (including you) must DISCARD a card. Shuffle the discard "
     "pile into the deck.",
     MYSTICAL_VORTEX, 0},
    {MAGIC, NOSPECIES, "Good Deal", "DRAW 3 cards and DISCARD a card", GOOD_DEAL, 0},
    ...
    {UPGRADE, NOSPECIES, "Glitter Bomb",
     ...
     "SACRIFICE a card, then DESTROY a card.",
     GLITTER_BOMB, 0},
    {UPGRADE, NOSPECIES, "Yay", "Cards you play cannot be Neigh'd.", YAY_EFFECT, 0},
    {UPGRADE, NOSPECIES, "Yay", "Cards you play cannot be Neigh'd.", YAY_EFFECT, 0},
    ...
    {UPGRADE, NOSPECIES, "Rainbow Aura",
     "Your Unicorn cards cannot be destroyed.", RAINBOW_AURA_EFFECT, 0},
